...
for (let i = 0; i < dropList.length; i++) {
    for(let currency_code in country_list){
        ...
        let selected = i == 0 ? currency_code == "INR" ? "selected" : "IN" : currency_code == "USD" ? "selected" : "";
...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/ab7e0c878925b6cd7f08971c/latest/${fromCurrency.value}`;
